...
/*changed by PengJQ*/
function mydiseaseType1(id){
    console.log('ok 1');
	var l1 = document.createElement("select");
	l1.className = "myform-control";
	l1.name = "first";
    var l2 = document.createElement("select");
    l2.className = "myform-control";
    l2.name = "second";
    var l3 = document.createElement("select");
    l3.className = "myform-control";
    l3.name = "third";
    var l4 = document.createElement("select");
    l4.className = "myform-control";
    l4.name = "fourth";
	$("#"+id).append(l1);
	$("#"+id).append(l2);
	$("#"+id).append(l3);
...
function mydiseaseType1change(id,dis1,dis2,dis3,dis4){
	var l1 = document.createElement("select");
	l1.className = "myform-control";
	l1.name = "first";
    var l2 = document.createElement("select");
	...
	for (var i=0;i<part1.length;i++){
        l1.options[l1.length] = new Option(part1[i].name, part1[i].name);
        if(dis1==part1[i].name)
            selectindex1 = i;
    }
    if(selectindex1>=0&&part1[selectindex1].children.length>0){
    for (var j=0;j<part1[selectindex1].children.length;j++){
        l2.options[l2.length] = new Option(part1[selectindex1].children[j].name, part1[selectindex1].children[j].name);
        if(dis2==part1[selectindex1].children[j].name)
            selectindex2 = j;
    }
        if(selectindex2>=0&&part1[selectindex1].children[selectindex2].children.length>0){
        for (var k=0;k<part1[selectindex1].children[selectindex2].children.length;k++){
            l3.options[l3.length] = new Option(part1[selectindex1].children[selectindex2].children[k].name,
                   part1[selectindex1].children[selectindex2].children[k].name);
            if(dis3==part1[selectindex1].children[selectindex2].children[k].name)
                selectindex3 = k;
        }
            if(selectindex3>=0&&part1[selectindex1].children[selectindex2].children[selectindex3].children.length>0){
            for (var l=0;l<part1[selectindex1].children[selectindex2].children[selectindex3].children.length;l++){
                l4.options[l4.length] = new Option(part1[selectindex1].children[selectindex2].children[selectindex3].children[l].name,
                    part1[selectindex1].children[selectindex2].children[selectindex3].children[l].name);
                if(dis4==part1[selectindex1].children[selectindex2].children[selectindex3].children[l].name)
                    selectindex4 = l;
            }}
    }}
    l1.selectedIndex = selectindex1+1;
    l2.selectedIndex = selectindex2+1;
    l3.selectedIndex = selectindex3+1;
    l4.selectedIndex = selectindex4+1;
...
function mydiseaseType2change(id,dis1,dis2,dis3,dis4) {
	var l1 = document.createElement("select");
	l1.className = "myform-control";
	l1.name = "subFirst";
    var l2 = document.createElement("select");
    ...
    for (var i=0;i<part2.length;i++){
        l1.options[l1.length] = new Option(part2[i].name, part2[i].name);
        if(dis1==part2[i].name)
            selectindex1 = i;
    }
    if(selectindex1>=0&&part2[selectindex1].children.length>0){
    for (var j=0;j<part2[selectindex1].children.length;j++){
        l2.options[l2.length] = new Option(part2[selectindex1].children[j].name, part2[selectindex1].children[j].name);
        if(dis2==part2[selectindex1].children[j].name)
            selectindex2 = j;
    }
        if(selectindex2>=0&&part2[selectindex1].children[selectindex2].children.length>0){
        for (var k=0;k<part2[selectindex1].children[selectindex2].children.length;k++){
            l3.options[l3.length] = new Option(part2[selectindex1].children[selectindex2].children[k].name,
                   part2[selectindex1].children[selectindex2].children[k].name);
            if(dis3==part2[selectindex1].children[selectindex2].children[k].name)
                selectindex3 = k;
        }
            if(selectindex3>=0&&part2[selectindex1].children[selectindex2].children[selectindex3].children.length>0){
            for (var l=0;l<part2[selectindex1].children[selectindex2].children[selectindex3].children.length;l++){
                l4.options[l4.length] = new Option(part2[selectindex1].children[selectindex2].children[selectindex3].children[l].name,
                    part2[selectindex1].children[selectindex2].children[selectindex3].children[l].name);
                if(dis4==part2[selectindex1].children[selectindex2].children[selectindex3].children[l].name)
                    selectindex4 = l;
            }}
    }}
    l1.selectedIndex = selectindex1+1;

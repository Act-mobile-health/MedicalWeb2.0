...
urlpatterns = [
    ...
    url(r'^patientRelation/$', patientRelation),
    url(r'^patientDetail/$', patientDetail),
    url(r'^patientAPPinfo/$', patientAPPinfo),
    url(r'^patientFollowUp/$', patientFollowUp),
    url(r'^patientDisease/$', patientDisease),
    ...
    url(r'^home/$', index_main),
    url(r'^personnel/$', index_main),
    url(r'^message/$', index_main),
    url(r'^patientinfos/$', index_main),
    url(r'^outpatientinfos/$', index_main),
    url(r'^emergencypatientinfos/$', index_main),
    url(r'^hospitalpatientinfos/$', index_main),
    url(r'^setting/$', index_main),
    url(r'^invite/$', index_main),
    url(r'^group/$', index_main),

    url(r'^index_main/$',index_main),
    url(r'^index_home/$',index_home),
    url(r'^index_personnel/$',index_personnel),
    url(r'^index_message/$',index_message),
    url(r'^index_patientinfos/$', index_patientinfos),
    url(r'^index_outpatientinfos/$', index_outpatientinfos),
    url(r'^index_emergencypatientinfos/$', index_emergencypatientinfos),
    url(r'^index_hospitalpatientinfos/$', index_hospitalpatientinfos),
    url(r'^index_setting/$', index_setting),
    url(r'^index_invite/$', index_invite),
    url(r'^index_group/$', index_group),
    ...
    url(r'^i57/',view.app_addPatientApp),
    ...
    url(r'^i109/',view.getAllVisitInfo),
    url(r'^i110/',view.deleteUser),
    url(r'^i111/',view.filterIdByAll),

    url(r'^i3000/',view.appVersion),
    # url(r'^i3002/',view.appVersion2),
    url(r'^i3001/',view.appUpdate),

    #url(r'^i9000/',view.getSkinColor),
    #url(r'^i9001/',view.updateSkinColor),
